...
alias pp="php ./vendor/bin/pest --parallel"
...
function phptags() {
    ctags -f .git/tags src app htdocs
...
alias php74="/opt/homebrew/Cellar/php@7.4/7.4.33_2/bin/php"
alias ditto="/Users/jaggy/Code/ditto-cli/ditto"
