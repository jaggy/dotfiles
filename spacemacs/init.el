...
(defun dotspacemacs/user-config ()
  ...
  (add-hook 'mmm-mode-hook (lambda ()
    ;; Dark Mode
    (set-face-background 'mmm-default-submode-face "#090e15")
