...
(custom-theme-set-faces
 ...
 '(default ((t (:foreground "#D9D7CE" :background "#091A21" ))))
 ...
 '(font-lock-comment-face ((t (:foreground "#5C6773" :background "#091A21"  :italic t))))
 ...
 '(font-lock-function-name-face ((t (:foreground "#FFAE57" :background "#091A21"  ))))
