...
(custom-theme-set-faces
 ...
 '(font-lock-comment-face ((t (:foreground "#5C6773" :background "#090e15"  :italic t))))
 ...
 '(font-lock-function-name-face ((t (:foreground "#FFAE57" :background "#090e15"  ))))
