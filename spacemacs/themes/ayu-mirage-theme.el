;;; ayu-mirage-theme.el --- an Emacs 24 theme based on ayu-mirage (tmTheme)
...
;;  from ayu-mirage (tmTheme) by Ike Ku
;;
;;; Code:

(deftheme ayu-mirage
  "ayu-mirage-theme - Created by tmtheme-to-deftheme - 2017-01-15 15:58:27 -0700")
...
(custom-theme-set-faces
 ...
 '(font-lock-comment-face ((t (:foreground "#5C6773" :background "#12161a"  :italic t))))
 ...
 '(font-lock-function-name-face ((t (:foreground "#FFAE57" :background "#12161a"  ))))
 ...
 ;; Multi Mode
 '(mmm-default-submode-face   ((t (:background "#12161a"))))
