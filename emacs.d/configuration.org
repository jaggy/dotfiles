        ...
        '(package-selected-packages
            (quote
                (
                    ...
                    ;; Theming
                    solarized-theme mustard-theme flatui-theme
...
#+BEGIN_SRC emacs-lisp
    ...
    (defun override-solarized-theme ()
        ...
        (set-face-attribute 'show-paren-match-face nil :foreground "orange" :underline)
        ...
        (set-face-background 'linum-relative-current-face "#f2f0e7")
        (set-face-foreground 'linum-relative-current-face "#b4b9be")

        (set-face-foreground 'vertical-border "white")
        (set-face-background 'vertical-border "white")

        (set-face-background 'whitespace-tab "#f2f0e7")
        (set-face-background 'mode-line "#f2f0e7")
        (set-face-background 'region "#f2f0e7")
        (set-face-foreground 'region "#black")

        (add-hook 'php-mode-hook (
            lambda()

            (set-face-foreground 'font-lock-comment-delimiter-face "#b4b9be")
            (set-face-foreground 'font-lock-comment-face "#b4b9be")
            ...
            (set-face-foreground 'php-annotations-annotation-face "red")
            (set-face-attribute 'font-lock-keyword-face nil :foreground "red")
            (set-face-attribute 'font-lock-function-name-face nil :foreground "orange")
        ))
    )
