        ...
        '(package-selected-packages
            (quote
                (
                    ...
                    evil-org evil-vimish-fold                                                    ;; EVIIIIIIIIIIIIIL
                    mustard-theme                                                                ;; Theming
                    helm projectile helm-projectile helm-ag                                      ;; Fuzzy Finder
                    php-mode web-mode emmet-mode                                                 ;; Web Stuff
                    magit yasnippet key-chord neotree linum-relative flycheck smart-mode-line    ;; Editor Specific
                )
            )
        )
    )
...
#+BEGIN_SRC emacs-lisp
    ...
    (set-face-background 'org-warning "black")  ;; Remove the highlight for the due stuff.
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
    ...
    (evil-define-key 'insert emmet-mode-keymap (kbd ",e") 'yas/expand)
#+END_SRC
