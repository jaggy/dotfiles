        ...
        '(package-selected-packages
            (quote
                (
                    ...
                    rjsx-mode pug-mode elixir-mode
...
#+BEGIN_SRC emacs-lisp
    ...
    (setq sml/shorten-mode-string nil)
    (setq sml/full-mode-string nil)
    (setq sml/show-remote nil)
    (setq sml/mule-info nil)
    (setq sml/outside-modified-char nil)
...
#+BEGIN_SRC emacs-lisp
    ...
    (defun override-solarized-light-theme ()
        ...
        (set-face-background 'linum-relative-current-face "#f2f2f2")
